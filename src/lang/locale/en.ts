...
const en = {
  ...
  "When toggled, cards will display the distance between today and the card's date. For example, 'in 3 days' or 'a month ago'. Relative dates will not be shown for dates from the tasks and dataview plugins.":
    "When toggled, cards will display the distance between today and the card's date. For example, 'in 3 days' or 'a month ago'. Relative dates will not be shown for dates from the tasks and dataview plugins.",
  ...
  'When toggled, the current date and time will be added to the card title when it is archived. For example: - [ ] 2021-05-14 10:00am my card title':
    'When toggled, the current date and time will be added to the card title when it is archived. For example: - [ ] 2021-05-14 10:00am my card title',
